...
class NotificantionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_notificantion)

        // Display arrow back at ActionBar
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        // Define action on button click listener
        findViewById<View>(R.id.btn_display_notification).setOnClickListener{createnotification()}
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // Create a new instance of NotificationChannel
    ...
    private fun createnotification() {
        ...
        // Set the lock screen visibility of the notification - PUBLIC / PRIVATE / SECRET
